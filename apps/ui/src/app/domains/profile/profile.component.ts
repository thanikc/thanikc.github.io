...
import { INTERESTS, PRINCIPLES, PROJECTS, TOOLBOX, WORK_THEMES } from './profile.content';

/**
 * The profile page, in narrative order: who (hero), what kind of work (themes),
 * evidence (projects), how (principles), the stack (toolbox), then personality.
 */
@Component({
