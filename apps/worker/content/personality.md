...
On the Myers-Briggs framework, Thanik Cheowtirakul comes out as INTP, the
"Logician" type. He first took the test more than 20 years ago and only recently
retook it. The introverted and thinking preferences came back strong and
consistent, while the intuitive and prospecting sides sit close to the midline,
so the type is best read as a lean rather than a label.
...
problems, a low tolerance for routine, and a tendency to pick at inconsistencies
until they resolve.
